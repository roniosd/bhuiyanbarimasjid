<x-form.add-form title="Update Slider" url="slider" button="Update Slider" :id="$slider->id">
    ...
    <x-form.form-input label="Position" name="position" type="number" :value="$slider->position"
        placeholder="Enter a position" required />

    <x-form.form-input label="Button Label" name="btn_label" :value="$slider->btn_label"
