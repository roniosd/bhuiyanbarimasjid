<x-app-layout title="Add Committee Year">
    <div class="content-area">


        <form action="{{ route('committee.store') }}" method="POST" enctype="multipart/form-data" class="row ">
            @csrf
                                ...
                                <div class="form-group custom-form-group">
                                    ...
                                    <select required name="session_id" class="form-control">
                                        ...
                                        @foreach ($sessions as $ses)
                                            <option value="{{ $ses->id }}"
                                                {{ old('session_id') == $ses->id ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group custom-form-group">
                                    ...
                                    <input type="text" name="membership_fee" class="form-control"
                                        placeholder="Enter membership fee" value="{{ old('membership_fee') }}">
                                </div>
                            </div>
