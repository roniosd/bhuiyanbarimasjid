<x-app-layout title="Create Admin">
    <div class="content-area">
        <form action="{{ route('adminmanage.store') }}" autocomplete="off" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group custom-form-group">
                                        ...
                                        <select name="role" id="" class="form-control">
                                            ...
                                            @forelse ($permissions as $permission)
                                                <option value="{{ $permission->id }}">{{ $permission->role_name }}
                                                </option>
                                            @empty
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-4">
                <div class="sidebar-widgets">
                    <div class="sidebar-widgets-inner">
                        ...
                        <x-admin.upload-image name='photo' title='Profile Image' size='150 X 150px' />
