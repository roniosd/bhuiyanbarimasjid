                    ...
                    <div class="custom-card p-1">
                        <div class="custom-card-header ">
                            ...
                            <div class="d-flex gap-4">
                                ...
                                <a class="btn btn-success" href="{{ route('event.create') }}">+</a>
                            </div>
                        </div>
                        <div class=" mt-5">
                            <div class="card ">
                                            ...
                                            <tbody>
                                                @foreach ($events as $event)
                                                    <tr>
                                                        ...
                                                        <td>{{ $event->title }}</td>
                                                        <td>{{ \Illuminate\Support\Str::limit($event->description, 50) }}
                                                        </td>
                                                        <td>{{ $event->getDate($event->start_date, 'd F Y') }}
                                                        </td>
                                                        <td>{{ $event->getDate($event->end_date, 'd F Y') }}
                                                        </td>
